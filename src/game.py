...
class Game:
    ...
    def __init__(self):
        ...
        #Timer do jogo
        self.game_timer = TimeGame(x=self.screen.get_width() /2, y=5) #Timer principal do jogo com eventos configurados.
    ...
    def SpawnBoss(self):
        ...
        Changed Attributes:
            boss (Boss): Instância do chefe gerado.
            boss_bar (BossBar): Barra de vida configurada para o chefe.
            spawned_boss (bool): Indica que o chefe foi gerado (True).
        """
